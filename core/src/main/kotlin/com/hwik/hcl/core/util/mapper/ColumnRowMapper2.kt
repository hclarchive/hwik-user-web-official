...
class ColumnRowMapper2<T1 : Any, T2 : Any, T : Any>(
) : ColumnRowMapperBase<T>() {
    constructor(kClass1: KClass<T1>, kClass2: KClass<T2>, kClass: KClass<T>, operation: (T1, T2) -> T, splitOn: List<String>) : this() {
        ...
        this.operation = { operation(entityList[0] as T1, entityList[1] as T2) }
    }
}