...
class ColumnRowMapper4<T1 : Any, T2 : Any, T3 : Any, T4 : Any, T : Any>(
    ...
    constructor(
        ...
        this.operation = { operation(entityList[0] as T1, entityList[1] as T2, entityList[2] as T3, entityList[3] as T4) }
    }
}